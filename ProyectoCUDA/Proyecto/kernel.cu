...
int main(int argc, char* argv[]) {
	...
	std::string img_file = "images\\img1.jpg";

	Mat image = imread(working_dir + img_file, CV_LOAD_IMAGE_COLOR);
    ...
    imwrite(working_dir + "Sobel_Image.jpg", gray_image);
    imwrite(working_dir + "Sobel_Image_opencv.jpg", abs_grad_x);
